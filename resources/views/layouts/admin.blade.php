...
<body class="fixed-left">
                ...
                <ul class="list-inline float-left mb-0">
                    ...
                    <li class="list-inline-item dropdown notification-list">
                        ...
                        <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown"
                            ...
                            <img src="{{ asset('admin_assets/images/favicon_1.ico') }}" style="" alt="user"
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('admin.home') }}" class="waves-effect"><i class="ti-home"></i> <span>
                                    الرئيسية </span></a></li>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="#" class="waves-effect"><span> الادوار </span></a></li>
                                <li><a href="#" class="waves-effect"> <span>المسئوليين </span></a></li>
                            </ul>
                        </li>
                    </ul>
    ...
    <script src="{{ asset('admin_assets/plugins/bootstrap-filestyle/js/bootstrap-filestyle.min.js') }}"
        type="text/javascript"></script>
    <script src="{{ asset('admin_assets/plugins/bootstrap-touchspin/js/jquery.bootstrap-touchspin.min.js') }}"
        type="text/javascript"></script>
    <script src="{{ asset('admin_assets/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js') }}"
        type="text/javascript"></script>
