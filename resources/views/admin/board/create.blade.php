...
@section('content')
    ...
    <div class="row">
        <div class="main-title-00">
            ...
            <a style="color: #fff;" href="{{ route('admin.boards.index') }}">/ اعضاء مجلس الإدارة / </a>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                {{ Form::open(['method' => 'POST', 'action' => ['App\Http\Controllers\Admin\BoardController@store'], 'files' => true]) }}
                    @csrf
                    <table class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td>الوظيفة انجليزي </td>
                                <td><input type="text" class="form-control" name="position_en" required
                                        value="{{ old('position_en') }}"></td>
                            ...
                            <tr>
                                <td>الوظيفة عربي</td>
                                <td><input type="text" class="form-control" name="position_ar" required
                                        value="{{ old('position_ar') }}"></td>
