...
@section('content')
    ...
    <div class="row">
        <div class="main-title-00">
            ...
            <a style="color: #fff;" href="{{ route('admin.district.index') }}">/ المناطق / </a>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="header-title m-t-0 m-b-20">تعديل بيانات المنطقة</h4>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="name" required
                                    value="{{ old('name') ? old('name') : $district->name }}"></td>
                            @if ($errors->has('name'))
