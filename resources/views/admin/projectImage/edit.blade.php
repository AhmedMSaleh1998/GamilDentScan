...
@section('content')
    ...
    <div class="row">
        <div class="main-title-00">
            ...
            <a style="color: #fff;" href="{{ route('admin.projects.index') }}">/ صور المشاريع / </a>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="header-title m-t-0 m-b-20">تعديل صورة المشروع</h4>
                {{ Form::model($projectImage,['method' => 'PATCH', 'action' => ['App\Http\Controllers\Admin\ProjectImageController@update', $projectImage->id], 'files' => true]) }}
                    <table class="table table-bordered table-striped">
                        <tbody>
                            <tr>
                                <td>الصورة</td>
                                <input type="hidden" name="project_id" value="{{ $projectImage->project_id }}">
                                <td>
