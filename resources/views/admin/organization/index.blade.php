    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="main-title-00">
                ...
                @endif
                <h4 class="page-title">المنظمات</h4>
            </div>
            ...
            <div class="card-box">
                ...
                <div class="table-responsive">
                    <table data-toggle="table" data-search="true" data-show-columns="true" data-sort-name="id"
                        ...
                        <thead>
                            <tr>
                                <th data-field="اسم الطبيب" data-align="center">اسم المنظمة</th>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <button type="button" class="btn btn-danger waves-effect" data-toggle="modal"
                                            data-target="#{{ $organization->id }}delete" title="حذف">حذف </button>
                                    </td>
                                </tr>

                                <div id="{{ $organization->id }}delete" class="modal fade" tabindex="-1" role="dialog"
