                        ...
                        @if(isset($contacts))
                            @foreach($contacts as $contact)
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a href="{{ route('admin.contacts.show',$contact->id) }}" class="btn btn-primary waves-effect" title="مشاهدة">مشاهدة</a>
                                        <button type="button" class="btn btn-danger waves-effect" data-toggle="modal"
                                                data-target="#{{ $contact->id }}delete" title="حذف">حذف </button>
                                    </td>
                                </tr>

                                <div id="{{ $contact->id }}delete" class="modal fade" tabindex="-1" role="dialog"
