        ...
        <div class="col-12">
            <div class="card-box">
                ...
                <table class="table table-bordered table-striped">
                    {{ Form::model($blog, ['method' => 'PATCH', 'action' => ['App\Http\Controllers\Admin\BlogController@update', $blog->id], 'files' => true]) }}
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('admin_assets/images/blogs/' . $blog->image) }}" class="img-responsive"
                        ...
                        <tr>
                            <td>الوصف انجليزى</td>
                            <td>
                                <textarea class="form-control" name="description_en"> {{ $blog->description_en }}</textarea>
                            </td>
                        ...
                        <tr>
                            <td>الوصف عربي</td>
                            <td>
                                <textarea class="form-control" name="description_ar"> {{ $blog->description_ar }}</textarea>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="content2" name="content_en">{{ old('content_en') ? old('content_en') : $blog->content_en }}</textarea>
                            </td>
                        ...
                        <tr>
                            <td>المحتوي عربي</td>
                            <td>
                                <textarea id="content2" name="content_ar">{{ old('content_en') ? old('content_en') : $blog->content_en }}</textarea>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" {{ $blog->home == 1 ? 'checked' : '' }} data-plugin="switchery"
