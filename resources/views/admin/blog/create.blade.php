        ...
        <div class="col-12">
            <div class="card-box">
                ...
                <table class="table table-bordered table-striped">
                    {{Form::open(['method'=>'POST','action' => ['App\Http\Controllers\Admin\BlogController@store'], 'files' => true])}}
                    {{-- <form method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data"> --}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" data-plugin="switchery" data-color="#5d9cec"
                                        data-switchery="true" style="display: none;" name="home" value="1">
                                    @if ($errors->has('home'))
                                        <span class="alert alert-danger">
